        ...
        <div class="flex-1 overflow-y-auto py-4 px-2">
          <nav class="flex-1 space-y-1">
            <RouterLink
              ...
              :key="item.name"
              :to="item.href"
              class="flex items-center px-2 py-2 text-base font-medium rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              <component
                :is="item.icon"
                class="mr-3 h-6 w-6 text-teal-600 dark:text-teal-400"
                aria-hidden="true"
              />
              {{ item.name }}
            </RouterLink>
      ...
      <div class="flex-1 flex flex-col overflow-y-auto">
        <nav class="flex-1 py-4 px-2 space-y-1">
          <RouterLink
            ...
            :key="item.name"
            :to="item.href"
            class="flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
          >
            <component
              :is="item.icon"
              class="mr-3 h-5 w-5 text-teal-600 dark:text-teal-400"
              aria-hidden="true"
            />
            {{ item.name }}
          </RouterLink>
